...
if(isset($_SESSION['id'])){
	$books = selectAll($table, ['user_id' =>  $_SESSION['id'] ]);

	$username = $_SESSION['username'];
}
else{

	$books = selectAll($table, ['user_id' =>  '0' ]);
...
if(isset($_GET['delete_id'])){
	...
	$_SESSION['type']= "success";
		header("location: " . BASE_URL . "/books/indexbook.php");
		exit();
}
...
if(isset($_POST['add-book'])){
	...
	if (count($errors)===0) {
		...
		$_SESSION['type']= "success";
		header("location: " . BASE_URL . "/post/index.php");
		exit();
	}else{
		$title = $_POST['title'];
		$body = $_POST['body'];
